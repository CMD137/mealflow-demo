...
public record SubmitOrderResponse(
  ...
  public static SubmitOrderResponse orderCreated(long orderId, long payOrderId, String status) {
    return new SubmitOrderResponse("ORDER_CREATED", orderId, payOrderId, status, null, null, 0, 0, null);
  }

  public static SubmitOrderResponse queued(long ticketId, String ticketNo, int aheadCount, int waitSeconds,
      LocalDateTime expireTime) {
