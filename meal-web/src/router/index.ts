  ...
  routes: [
    ...
    { path: '/login/:pathMatch(.*)*', redirect: '/login', meta: { public: true } },
    {
      ...
      children: [
        ...
        { path: 'system/merchants', component: () => import('@/views/system/MerchantsView.vue'), meta: { title: '商家治理', permission: 'SYSTEM_MERCHANT_READ' } },
        { path: 'system/users', component: () => import('@/views/system/UsersView.vue'), meta: { title: '用户治理', permission: 'SYSTEM_USER_READ' } },
        { path: 'system/orders', component: () => import('@/views/system/OrdersView.vue'), meta: { title: '全局订单', permission: 'SYSTEM_ORDER_READ' } },
